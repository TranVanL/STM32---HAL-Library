...
#define LED_ON_EXTI_IRQn EXTI0_IRQn
#define LED_OFF_Pin GPIO_PIN_1
#define LED_OFF_GPIO_Port GPIOA
#define LED_OFF_EXTI_IRQn EXTI1_IRQn
#define BLINK_LED_Pin GPIO_PIN_3
#define BLINK_LED_GPIO_Port GPIOA
#define BLINK_LED_EXTI_IRQn EXTI3_IRQn
